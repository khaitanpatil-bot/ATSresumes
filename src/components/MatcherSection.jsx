const matchData = {
  ...
  suggestion: 'Add 3 bullet points to better align with the job description.'
}

export default function MatcherSection() {
  return (
    <section id="dashboard" className="space-y-8 rounded-[2rem] bg-slate-900/80 p-8 shadow-2xl shadow-slate-950/40">
      <div>
        <p className="text-sm uppercase tracking-[0.2em] text-emerald-400">Job Description Matcher</p>
        <h2 className="mt-3 text-3xl font-semibold text-white">Match your resume to the job description.</h2>
      </div>
